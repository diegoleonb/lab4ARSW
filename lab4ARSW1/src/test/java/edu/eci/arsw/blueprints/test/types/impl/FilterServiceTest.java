...
public class FilterServiceTest {
    ...
    @Test
    public void filterRedundacyBlueprint() throws BlueprintNotFoundException, BlueprintPersistenceException{
        ...
        Blueprint bp1 = new Blueprint("diego","2",pts1);
        Blueprint bp2 = new Blueprint("diego","3",new Point[]{});
    ...
    @Test
    public void filterRedundacyBluePrintByAuthor() throws BlueprintNotFoundException, BlueprintPersistenceException{
        FilterRedundancy fr = new FilterRedundancy();
        Point[] pts0=new Point[]{new Point(40, 40),new Point(15,15),new Point(40,40), new Point(40,40),new Point(15, 15),new Point(15,15)};
        Point[] pts1 = new Point[]{new Point(15,14)};
        Blueprint bp0=new Blueprint("norbey", "mp",pts0);
        ...
        sbp.add(bp0);sbp.add(bp1);sbp.add(bp2);
        try {
            fr.filterPrintsByAuthor("diego",sbp);
        } catch (BlueprintNotFoundException e) {
            e.printStackTrace();
        }
        Object[] sbpA = sbp.toArray();
    ...
    @Test
    public void filterRedundacySubmuestreo() throws BlueprintNotFoundException, BlueprintPersistenceException{
    ...
    @Test
    public void filterRedundacySubmuestreosBluePrints() throws BlueprintNotFoundException, BlueprintPersistenceException{
        FilterSub fs = new FilterSub();
        Point[] pts0 = new Point[]{new Point(10,10),new Point(14,12),new Point(19,20),new Point(34,25),new Point(1,4),
                new Point(14,18),new Point(1,4),new Point(9,80),new Point(8,7), new Point(14,25)};
        Point[] pts1 = new Point[]{new Point(1,2),new Point(2,6)};
    ...
    @Test
    public void filterRedundacySubmuestreoByAuthor() throws BlueprintNotFoundException, BlueprintPersistenceException{
        FilterSub fs = new FilterSub();
        Point[] pts0 = new Point[]{new Point(10,10),new Point(14,12),new Point(19,20),new Point(34,25),new Point(1,4),
                new Point(14,18),new Point(1,4),new Point(9,80),new Point(8,7), new Point(14,25)};
        Point[] pts1 = new Point[]{new Point(1,2),new Point(2,6)};
        ...
        sbp.add(bp0);sbp.add(bp1);sbp.add(bp2);
        try {
            fs.filterPrintsByAuthor("diego",sbp);
        } catch (BlueprintNotFoundException e) {
            e.printStackTrace();
        }
        Object[] sbpA = sbp.toArray();
